...
function applyConfig() {
  ...
  // Первый экран — неизменяемый hero-конверт master-шаблона.
  // Портрет клиента не подставляется сюда: его разрешено использовать
  // только в отдельном согласованном фото-блоке.
